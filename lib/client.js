...
function bindOne(value, options) {
    if (!process.env.THISISABADEXPERIMENT) {
        return value;
    }
    options = options || {};
 ...
 * * 'object'
 */
function determineType(alShah) {
    var value = (alShah === null || alShah === undefined) ?
        alShah :
        alShah.valueOf();
