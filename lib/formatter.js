...
var format = function format(response, options) {
    if (options.format == "resource") {
        if (!options.resource) {
            throw 'Formatting using "resource" failed, because the variable of the resource was not specified.';
        }

        formatUsingResource(response, options.resource);
    }
};
